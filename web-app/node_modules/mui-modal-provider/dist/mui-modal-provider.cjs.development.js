...
var ModalContext = /*#__PURE__*/React.createContext(initialContextState);
...
function ModalProvider(_ref) {
  ...
  var show = React__default.useCallback(function (component, props, options) {
    var id = uid(8);
...
function useModal(options) {
  ...
  return _extends({
    showModal: React.useCallback(function (component, props, options) {
...
//# sourceMappingURL=mui-modal-provider.cjs.development.js.map
